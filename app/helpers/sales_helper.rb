module SalesHelper
  def payment_hash
      ...
      { "Nakit Ödeme" =>  "Nakit ödeme olarak fiyatlandırılmıştır. - Cash payment before shipment" , 
        "%20 siparişte" => "%20 siparişte, %80 bakiyesi fabrikadan sevkiyata hazır olduğunda - T/T 20% advance payment with order, 80% on advice goods ready for delivery",
        "%30 siparişte" => "%30 siparişte, %70 bakiyesi fabrikadan sevkiyata hazır olduğunda - T/T 30% advance payment with order, 70% on advice goods ready for delivery",
      "Karşılıklı Görüşme" => "Karşılıklı görüşmeler neticesinde belirlenecektir - Will be clearify after negotiations",
        ...
        "Vadeli" => "Belirtilen vadelerde ödenecektir",
  ...
  def delivery_condition_hash
    {
      "Ex-Works DEPO" => "İstanbul-Türkiye Satıcı Depolarından teslim - EXW Istanbul/TURKEY incoterms 2010",
      "Ex-Works URETICI" => "Üretici firma fabrikasından teslim edilecektir- EXW EX-WORKS incoterms 2010",
